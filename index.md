...
このシビアな目安を満たすためには、設計の洗練が必要不可欠である。タイムアウト値を憲法として定め、タイムアウトが発生する場合は設計を疑え
またリッチな処理を行いがちなエンプラ向けのサードパーティ製品（特にSCAその他品質評価系製品）とも相性が悪い。これらの製品はCI/CD統合できないか、処理時間がコーヒータイムを超えてしまうか、あるいは両方を患っている。軽量でカスタマイズ可能なオープンソースで代替せよ。あるいは、どうしても製品を使いたいなら、FASDの試行錯誤体験を損なわないよう、ツール呼び出しとして使えるよう整えるべきだ。この手間と予算を惜しんではいけない。経験上、予算の部分で渋る事が多い。ということは、絶対必要だとは思っていないということだ。ならばオープンソースの代替で良い。そもそも「サードパーティ製品だから安心」という他力本願の精神が良くない
